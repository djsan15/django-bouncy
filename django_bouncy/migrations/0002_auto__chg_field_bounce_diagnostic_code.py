...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'django_bouncy_bounce', 'diagnostic_code', self.gf('django.db.models.fields.CharField')(max_length=5000, null=True))
    ...
    models = {
        u'django_bouncy.bounce': {
            ...
            'diagnostic_code': ('django.db.models.fields.CharField', [], {'max_length': '5000', 'null': 'True', 'blank': 'True'}),
